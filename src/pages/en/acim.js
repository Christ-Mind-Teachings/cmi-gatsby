  ...
  return (
    <>
      <div ref={contextRef}>
        ...
        >
          <Container attached="bottom" text>
            ...
            <p>
              ...
              curriculum consisting of a Text, Workbook for Students, and Manual
              for Teachers, it teaches that the way to universal love and
              peace—or remembering God—is by undoing guilt through forgiving
              others. The Course thus focuses on the healing of relationships
              and making them holy. A Course in Miracles also emphasizes that it
              is but one version of the universal curriculum, of which there are
              “many thousands.” Consequently, even though the language of the
              Course is that of traditional Christianity, it expresses a
              non-sectarian, non-denominational spirituality. A Course in
              Miracles, therefore, is a universal spiritual teaching, not a
              religion.
            </p>
            <p>
              See{' '}
              ...
              <Grid.Row>
                ...
                <Grid.Column width={10}>
                  <Segment basic>
                    ...
                    <p>
                      This version includes audio beautifully presented and read
                      by Martin Weber-Caspers.
                    </p>
                  </Segment>
                </Grid.Column>
              </Grid.Row>
